...
function loadModel(modelName) {
    ...
    if (modelVersion === 2) {
        ...
        window.live2dv2.load(live2dId2, `${live2d_settings.modelUrl}/${modelName}/Full/${modelName.substring(0,3)}_${modelName.substring(3).toLowerCase()}_${modelName.split('/')[1].toLowerCase()}.model.json`);
