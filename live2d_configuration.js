...
function loadModel(modelName) {
    ...
    if (modelVersion === 2) {
        ...
        window.live2dv2.load(live2dId2, `${live2d_settings.modelUrl}/${modelName}/Full/${waifu.dataset.id}_${modelName.split('/')[0].toLowerCase()}_${modelName.split('/')[1].toLowerCase()}.model.json`);
